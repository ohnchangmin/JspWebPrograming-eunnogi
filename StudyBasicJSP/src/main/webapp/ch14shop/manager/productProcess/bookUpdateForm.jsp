...
%>
			...
			<p>책 수정</p>
			<br>
			<form action="bookUpdatePro.jsp" method="post" name="writeform" enctype="multipart/form-data">
				<table>
					<tr>
					...
					<tr>
						...
						<td width="400" align="left">
							<input type="text" size="20" maxlength="30" name="publishing_com" value="<%=book.getPublishing_com()%>">
						</td>
					</tr>					
					<tr>
